...
export declare type OptionalTuNullable<O> = {
 ...
 * @docsPage Email Plugin Types
 */
export declare type EmailAttachment = Omit<Attachment, 'content' | 'raw'> & {
    path: string;
};
export declare type SerializedAttachment = OptionalTuNullable<EmailAttachment>;
