...
import { EventBus, JobQueueService, Type } from '@vendure/core';
...
export declare class EmailPlugin implements OnApplicationBootstrap, NestModule {
    ...
    /** @internal */
    constructor(eventBus: EventBus, moduleRef: ModuleRef, emailProcessor: EmailProcessor, jobQueueService: JobQueueService);
    /**
