...
class EmailEventHandler {
    ...
    async handle(event, globals = {}, injector) {
        ...
        const attachments = await attachment_utils_1.serializeAttachments((_b = (await ((_a = this.setAttachmentsFn) === null || _a === void 0 ? void 0 : _a.call(this, event)))) !== null && _b !== void 0 ? _b : []);
        return {
            type: this.type,
            recipient,
            from: this.from,
            templateVars: Object.assign(Object.assign({}, globals), templateVars),
            subject,
