...
function generateErrorCodeEnum(typeDefsOrSchema) {
    ...
    const errorNodes = Object.values(schema.getTypeMap())
        ...
        var _a;
        return (node &&
            (node === null || node === void 0 ? void 0 : node.kind) === 'ObjectTypeDefinition' && ((_a = node.interfaces) === null || _a === void 0 ? void 0 : _a.map(i => i.name.value).includes(exports.ERROR_INTERFACE_NAME)));
    });
