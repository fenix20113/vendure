...
let ExternalAuthenticationService = class ExternalAuthenticationService {
    constructor(connection, roleService, historyService, customerService, administratorService, channelService, userService) {
    ...
    async findUser(ctx, strategy, externalIdentifier) {
        const user = await this.connection
            ...
            .getOne();
        const userHasMatchingAuthMethod = !!(user === null || user === void 0 ? void 0 : user.authenticationMethods.find(m => {
